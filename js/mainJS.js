...
function showSendPayload() {
	var resultoutputtext = document.getElementById("goButton");
	resultoutputtext.style.display = "block";
}

function showConsole() {
	var resultoutputtext = document.getElementById("resultoutput");
	resultoutputtext.style.display = "block";
}
